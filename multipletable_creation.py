"""I have one excel workbooksheet into multiple work sheets so i want to create multiple tables using this
excel workbook and insert data using that work sheets after delete that work sheets data then
update i added new data same workbook after update delete data that work sheets data then export data
in different work sheets and drop tables if not need so suing python with sql server full code no errors expectd
after complie in to my system"""
...
excel_path = r'C:\Users\malle\Downloads\SampleSuperstorenine.xlsx'
